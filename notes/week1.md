...
In summary statical typing brings us ...
...
- To run a class, we must defina a `main` method
...
- `public int weightInPounds;`: **Instance variable**
    - Can have as many of thse as we want
...
- One special role for `Strings[]`: **Command Line Argments**

...
1. [Lec.3 - References and Recursion](#lec3-references-and-recursion)
    1. [Primitive types](#primitive-types)
    2. [The Golden Rule of Equals (GRoE)](#the-golden-rule-of-equals-groe)
    3. [Reference Types](#reference-types)
    4. [Parameter Passing](#parameter-passing)
    5. [Instantiating Arrays](#instantiating-arrays)
    6. [Introducing IntLists](#introducing-intlists)
2. [Lec.4 - Node Based List](#lec4-node-based-list)
    1. [Rebranding and Bureaucracy](#rebranding-and-bureaucracy)
    2. [Access Control](#access-control)
    3. [Nested Class](#nested-class)
    4. [Caching](#caching)
    5. [Empty list](#empty-list)
    6. [Sentinel Node](#sentinel-node)
    7. [Invariants](#invariants)
3. [Lec.5 - Doubly Linked List and Arrays](#lec5-doubly-linked-list-and-arrays)
    1. [Doubly Linked List](#doubly-linked-list)
    2. [Generics](#generics)
    3. [Arrays](#arrays)
    4. [Arrays vs. Classes](#arrays-vs-classes)
...
There are two ways to implement these methods: recursively or iteratively.
